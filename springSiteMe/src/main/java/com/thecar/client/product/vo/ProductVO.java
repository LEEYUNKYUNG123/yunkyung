...
public class ProductVO {
	...
	public ProductVO() {}
	public ProductVO(int c_no, String c_name, String c_num, String c_type, String c_seater, String c_fuel, int c_year,
			String c_color, String c_crt, String c_else, String c_det, String c_ins, String c_sii, String c_rent) {
		super();
		this.c_no = c_no;
		this.c_name = c_name;
		this.c_num = c_num;
