		...
		<div class="well">
			<form id="memberForm" class="form-horizontal">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-4">
						<input type="text" id="m_brd" name="m_brd" maxlength="6"
							class="form-control"
							placeholder="주민등록번호 앞 6자리 입력 (ex 990218)">
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-4">
						<input type="radio" id="m_gender" name="m_gender" value="F"> 남자
						<input type="radio" id="m_gender" name="m_gender" value="W"> 여자
					</div>
				</div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-4">
						<input type="text" id="m_stDate" name="m_stDate" maxlength="8" class="form-control"
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-4">
						<input type="text" id="m_enDate" name="m_enDate" maxlength="8" class="form-control"
							placeholder="년,월,일 순으로 8개의 숫자로 입력(ex 20250504)">
					</div>
					
					<br><br><br>
					<div class="dirrks">
						<h4 style="margin-left: 100px;">덕카 서비스 약관에 동의해주세요.</h4>
						<div class="form-group form-group-sm" style="margin-left: 100px;">
							<input type="radio" id="dong1" required> [필수] 덕카 이용약관 동의
							<br> <input type="radio" id="dong2" required> [필수]
							개일정보 수집 및 동의
						</div>
					</div>
					<br><br>
